...
import com.nicholasgot.sunshineapp.data.WeatherContract.WeatherEntry;
import com.nicholasgot.sunshineapp.data.WeatherDbHelper;
...
//    private ForecastAdapter mForecastAdapter;
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        //int colIndex = locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, values);
            }
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, BuildConfig.OPEN_WEATHER_MAP_API_KEY) // API key
                    .build();
